...
def simulation(n_runs, n_words, n_dimensions, seed, n_exemplars=100, n_continuers=0, similarity_bias_word=True,
    ...
    return lexicon, lexicon2, indices_meta, indices_meta2
...
def simulation_runs(n_runs, n_rounds, n_words, n_dimensions, seed, n_exemplars=100, n_continuers=0,
    ...
    results = pd.DataFrame(columns=["Simulation_run", "Agent", "Word", "Centroid", "Average_distance",
                                    ...
                                    "N_dimensions", "Seed", "N_exemplars", "N_continuers", "N_rounds"])

    for n_run in range(n_runs):
        lexicon, lexicon2, indices_meta, indices_meta2 = simulation(n_rounds, n_words, n_dimensions, seed, n_exemplars,
        ...
        for word_index in range(n_words):
            ...
            results.loc[len(results)] = [n_run, 1, word_index, centroid, average_distance, lexicon, indices_meta,
                                         ...
                                         n_words, n_dimensions, seed, n_exemplars, n_continuers, n_rounds]
