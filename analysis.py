...
def analysis(results_folder, plots_folder, results_file, intermediate=None, wedel_start=True):
    ...
    if results["Anti_ambiguity_bias"].iloc[0]:
        ...
        plt.savefig(plots_folder + "start_exemplars_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    else:
        ...
        plt.savefig(plots_folder + "start_exemplars_no_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    plt.clf()
    ...
    if results["Anti_ambiguity_bias"].iloc[0]:
        ...
        plt.savefig(plots_folder + "exemplars_amb_" +str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_"+ str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    else:
        ...
        plt.savefig(plots_folder + "exemplars_no_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    plt.clf()
    ...
    if results["Anti_ambiguity_bias"].iloc[0]:
        ...
        plt.savefig(plots_folder + "centroid_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    else:
        ...
        plt.savefig(plots_folder + "centroid_no_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    plt.clf()
    ...
    if results["Anti_ambiguity_bias"].iloc[0]:
        ...
        plt.savefig(plots_folder + "sd_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    else:
        ...
        plt.savefig(plots_folder + "sd_no_amb_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_" + str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    plt.clf()
    ...
    plt.savefig(plots_folder + "collateral_"+str(results.iloc[-1]["Simulation_run"] + 1) + "_runs_" + str(n_rounds) + "_rounds_"+ str(results.iloc[-1]["Word_similarity_weight"]) + "_" + str(results.iloc[-1]["Segment_similarity_weight"]) + "_" + str(results.iloc[-1]["Continuer_G"]) + ".pdf")
    plt.clf()
